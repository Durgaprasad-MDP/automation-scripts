...
driver.manage().window().maximize();
        ...
        Thread.sleep(3000);
        		  WebElement ta = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@placeholder='Email Address']")));
        		  JavascriptExecutor jsExecutor5 = (JavascriptExecutor) driver;
          		jsExecutor5.executeScript("arguments[0].scrollIntoView(true);", ta);
          		 
        		  ta.click();
        	        ta.sendKeys("durgamdp@gmail.com");
        	        Thread.sleep(3000); 
        	        
        	        WebElement cb = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='slds-checkbox_faux']")));
          		  JavascriptExecutor jsExecutor9 = (JavascriptExecutor) driver;

        	        jsExecutor9.executeScript("arguments[0].scrollIntoView(true);", cb);
