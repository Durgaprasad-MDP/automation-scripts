...
public class fmd2 {
	...
	public static void main(String[] args) throws Exception {
       ...
       //wait.until(ExpectedConditions.elementToBeClickable(By.className("slds-r2"))).click();
        ...
        searchResult.click();
        Thread.sleep(6000); 
        WebElement object = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@placeholder='Search Objects']")));
        object.sendKeys("order");

        Thread.sleep(6000);
        WebElement searchResult1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[contains(@data-label,'order')]")));
        searchResult1.click();
        Thread.sleep(6000); 
