...
public class rrrrr {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Locate and click the "Qualification" option
        WebElement qualificationOption = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='select' and @data-interactive-lib-uid='10' and text()='Qualification']")));
