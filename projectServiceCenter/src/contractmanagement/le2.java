...
import org.openqa.selenium.support.ui.WebDriverWait;
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            // Navigate back to the Leads tab
            WebElement leadsTab = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@data-aura-rendered-by=\"462:83;a\"]")));
           // wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[@class
