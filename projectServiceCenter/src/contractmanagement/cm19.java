...
public class cm19 {
	...
	public static void main(String[] args) throws InterruptedException {
       ...
       //wait.until(ExpectedConditions.elementToBeClickable(By.className("slds-r2"))).click();
        ...
        WebElement contract = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@class='slds-button slds-button_brand b1' and text()='I need a sourcing event']")));
        contract.click();
        Thread.sleep(6000);
